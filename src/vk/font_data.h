...
constexpr int font_chars = 256;
constexpr int font_cols = 16;
constexpr int font_rows = 16;
constexpr uint8_t font_data[font_chars * font_height] = {
...
constexpr int font_atlas_w = font_cols * font_width;
constexpr int font_atlas_h = font_rows * font_height;
}
